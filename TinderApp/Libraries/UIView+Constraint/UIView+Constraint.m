...
- (NSLayoutConstraint *)addConstraintGreaterThanFromRight:(CGFloat)distance
{
    return [self addConstraintWithVisualFormat:@"H:[self]-(>=distance)-|" distance:distance];
}
...
- (NSLayoutConstraint *)addConstraintHeight:(CGFloat)height relation:(NSLayoutRelation)relate
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    NSLayoutConstraint *constraint = [NSLayoutConstraint constraintWithItem:self
                                                                  attribute:NSLayoutAttributeHeight
...
- (NSLayoutConstraint *)addConstraintMutipler:(CGFloat)mutipler
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    NSLayoutConstraint *constraint = [NSLayoutConstraint constraintWithItem:self
                                                                  attribute:NSLayoutAttributeHeight
...
- (NSLayoutConstraint *)addConstraintAlignView:(UIView *)baseView layoutAttribute:(NSLayoutAttribute)attribute mutipler:(CGFloat)mutipler
{
    if (!baseView) return nil;
    UIView *superview = self.superview;
    if (!superview) return nil;
...
- (NSLayoutConstraint *)addConstraintAlignViewCenteringY:(UIView *)baseView
{
    return [self addConstraintAlignViewCenteringY:baseView offset:0];
}
- (NSLayoutConstraint *)addConstraintAlignViewCenteringY:(UIView *)baseView offset:(CGFloat)offset
{
    return [self addConstraintAlignView:baseView layoutAttribute:NSLayoutAttributeCenterY offset:offset];
}
- (NSLayoutConstraint *)addConstraintAlignViewHeight:(UIView *)baseView mutipler:(CGFloat)mutipler
{
    return [self addConstraintAlignView:baseView layoutAttribute:NSLayoutAttributeHeight mutipler:mutipler];
}
- (NSLayoutConstraint *)addConstraintAlignViewWidth:(UIView *)baseView mutipler:(CGFloat)mutipler
{
    return [self addConstraintAlignView:baseView layoutAttribute:NSLayoutAttributeWidth mutipler:mutipler];
}
